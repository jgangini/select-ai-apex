...
When `--mode new` targets a bundled demo listed in `data/demo/manifest.json`, the generated ADMIN SQL creates the repository-owned demo schema from JSON metadata under `data/demo/<folder>/data`.
