...
def demo_catalog() -> list[dict[str, Any]]:
    ...
    if not isinstance(demos, list):
        raise ValidationError("data/demo/manifest.json must contain a demos array")
...
def render_demo_schema_ddl(entry: DemoSchemaEntry, *, app_schema: str, demo_password: str) -> str:
    ...
    lines: list[str] = [
        f"-- Demo schema {entry.schema} is created from data/demo/{entry.folder}/manifest.json and data/*.csv.",
